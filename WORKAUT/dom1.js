...
//firstChild, lastChild, childNodes,firstElementnyChild,lastElementnyChild
...
console.log(document.getElementById("card4").getAttribute('data-myda'));
console.log(document.getElementById("card4").dataset);
console.log(document.getElementById("card4").dataset.myda);
